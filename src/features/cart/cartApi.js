...
export const { useAddToTheCartMutation, useGetCartProductsByEmailQuery, useDeleteFromCartMutation, useUpdateCartProductMutation, useDeleteAllFromCartMutation } = cartApi;
